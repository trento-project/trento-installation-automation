...
5. Installs the Trento Ansible collection on control machines
6. Runs the `suse.trento.site` Ansible playbook to install Trento & Trento agent (Agents are installed on same machine as Trento server).
7. Optionally destroys the infrastructure after tests
